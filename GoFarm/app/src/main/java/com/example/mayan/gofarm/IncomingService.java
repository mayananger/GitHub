    ...
    class IncomingThread extends Thread {
        ...
        public void run() {
            ...
            while (Run) {
                ...
                MainActivity.setCucumber_Quantity(MainActivity.getCucumber_Quantity()+inco_Cucumber);
                MainActivity.setCarrots_Quantity(MainActivity.getCarrots_Quantity()+inco_Carrots);
                MainActivity.setEggplant_Quantity(MainActivity.getEggplant_Quantity()+inco_Eggplant);
                MainActivity.setStrawberries_Quantity(MainActivity.getStrawberries_Quantity()+inco_Starwberries);
                MainActivity.setWatermelon_Quantity(MainActivity.getWatermelon_Quantity()+inco_Watermelon);
                MainActivity.setMelon_Quantity(MainActivity.getMelon_Quantity()+inco_Melon);
